...
\subsubsection{Interrogation de Jacques Crégut}
...
Pour aller à \textbf{Anduze} il serait passé par \textbf{Mandagout, Taleyrac, Bonnerrier, les Plantier de Saint Michel de Fonfouillouse}, par \textbf{Saumane} où il aurait rencontré la troupe de fanatiques dont le chef était le nommé Castanet de \textbf{Massevaques}\footnote{Henri Castanet, né en 1673 et mort en 1705, ancien garde forestier de l’Aigoual, est le chef camisard du Mont Aigoual. Il organise la troupe dite du « Camp de l'Éternel ». Il partage son commandement avec son lieutenant Jean La Rose (ou Laroze).}.

C’était un petit homme assez gros, portant une perruque blonde, habillé de minime\footnote{Tunique brune} doublée de rouge, portant sur le chapeau un crêpe, disant qu’il faisait le deuil de son père.
...
Il a été à son village depuis le mois de mai 1702, et 5 à 10 jours il fut à Camprieu pour dépiquer\footnote{Séparer le grain de l'épi.} le blé de sa sœur.
...
N° 21504 -- Pierre Bertrand fils de David et de Marie Lagar, laboureur, natif de Campy\footnote{Campis.} en Cévennes, âgé de 22 ans, bonne taille, cheveux châtains, visage rond, de la RPR \textbf{condamné pour assemblées, à vie}. Affecté à la galère \textit{La grande Réale} à Marseille.

Mention marginale : Mort à l’hospital le 21\textsuperscript{e} aoust\footnote{Août} 1705.
