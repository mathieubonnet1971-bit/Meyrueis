...
Un texte de 1558, relevé dans les papiers de l’Eglise Catholique de Meyrueis indique que la population est « infestée de la mâle (mauvaise) opinion » C’est semble-t-il, fin 1559 que la ville procède à sa Réformation en décrétant l’abolition de la messe puisque la presque totalité de la population était passée à la Réforme. L’Eglise Réformée s’organise et reçoit son premier pasteur François Thérond, originaire de Sauve. Il doit desservir avec Meyrueis, Gatuzières, Lanuéjols, Montjardin et Saint Sauveur des Pourcils. Deux ans plus tard on lui demande de « dresser » l’Eglise Réformée de Marvejols en plein Gévaudan. ».*
...
\begin{quote}
\itshape
« Les Meyrueisiens prirent une part active aux opérations militaires dont la région fut le théâtre en cette fin du XVI\textsuperscript{o} siècle jusqu’à l’Edit de Nantes (13 avril 1598). Après une relative accalmie les troubles reprirent vers 1620 pour ne plus s’arrêter, en ce qui concerne les persécutions, jusqu’à la veille de la révolution, avec l’édit de 1787 rendant aux non catholiques une existence légale ».*
\end{quote}

\begin{itemize}
  \item[] \textit{Philippe Chambon dans « Itinéraires Protestants en Cévennes » p.70}
\end{itemize}
