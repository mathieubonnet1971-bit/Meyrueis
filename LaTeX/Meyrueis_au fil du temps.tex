...
\input{pages/001-première-de-couverture}
%\includepdf{pdf/001.pdf}
\clearpage
\newpage

% ------------------------------------------------------------
% Retour au format du livre : A4 avec marges
% ------------------------------------------------------------
\pagenormale

\input{pages/002-page de garde}
\clearpage

\input{pages/003-toc}
\clearpage

\input{pages/004-carte}
\clearpage
...
\input{pages/011-protestants-catholiques-révolution}
\clearpage

\input{pages/012-Samuel-François}
\clearpage
...
\input{pages/015-mémoire}
\clearpage

\input{pages/016-schiste-bleu}
\clearpage

\input{pages/017-chapeliers}
\clearpage

\input{pages/018-la-Douce}
\clearpage

\input{pages/019-entre-deux-guerres}
\clearpage

\input{pages/020-Jean-Gounelle}
\clearpage

\input{pages/021-chantiers-jeunesse}
\clearpage

\input{pages/022-1942-1944}
\clearpage

\input{pages/023-anecdotes-témoignages-souvenirs}
\clearpage
